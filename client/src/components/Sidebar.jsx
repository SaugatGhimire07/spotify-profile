...
function Sidebar() {
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          height="100%"
        >
          <path d="M267.75,12.75c-89.25,0-168.3,48.45-209.1,122.4L0,76.5v165.75h165.75l-71.4-71.4c33.15-63.75,96.9-107.1,173.4-107.1C372.3,63.75,459,150.45,459,255s-86.7,191.25-191.25,191.25c-84.15,0-153-53.55-181.05-127.5H33.15c28.05,102,122.4,178.5,234.6,178.5C402.9,497.25,510,387.6,510,255C510,122.4,400.35,12.75,267.75,12.75z M229.5,140.25V270.3l119.85,71.4l20.4-33.15l-102-61.2v-107.1H229.5z"></path>
        </svg>
      ),
    },
    {
  ...
  return (
    <div
      className="fixed top-0 left-0 h-screen w-[100px] bg-[#040406] flex flex-col justify-between"
    ...
    >
          ...
          {navItems.map((item) => (
            <li key={item.name} className="w-full flex flex-col items-center">
              ...
              >
                ...
                <span className="text-center" style={{ fontSize: "11px" }}>
                  {item.name}
                </span>
              </Link>
            </li>
      ...
      {/* GitHub Link */}
      <div className="flex flex-col items-center mb-[30px] border-gray-800">
        <a
        ...
        >
          <svg
            ...
            width="20"
            height="20"
            className="mb-1 fill-current w-[30px] h-[30px]"
          >
            <title>Github</title>
