...
function ArtistDetail({ token }) {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      <Sidebar />
      <div className="w-full md:flex-1 lg:ml-[100px] flex md:block items-center justify-center md:items-start md:justify-start min-h-screen">
        <div className="bg-[#181818] p-[20px] md:py-[40px] md:px-[30px] lg:p-[80px] max-w-[1400px] w-full">
          {firstLoad ? (
