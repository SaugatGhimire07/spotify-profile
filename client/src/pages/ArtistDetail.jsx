  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="w-full md:flex-1 md:ml-[100px]">
        <div className="bg-[#181818] p-[20px] md:py-[40px] md:px-[30px] lg:p-[80px] max-w-[1400px] mx-auto">
          {firstLoad ? (
            ...
            <div className="relative">
              ...
              >
                {/* Artist Artwork */}
                <div className="w-[200px] h-[200px] sm:w-[250px] sm:h-[250px] md:w-[300px] md:h-[300px] rounded-full overflow-hidden mb-[20px] md:mb-[30px]">
                  <img
